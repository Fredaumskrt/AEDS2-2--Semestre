...
class PeopleList {
    ...
    public void add(People people) throws Exception {
        ...
        if(n >= array.length) throw new Exception("Insert error: There is not enough space.");
    ...
    public People search(String name) { 
        ...
        for(int i = 0; i < this.n; i++) {
            ...
            if(array[i].getName().compareTo(name) == 0) return array[i];
        }
        return null;
    }
        ...
        for(int i = 0; i < 26; i++) {
            ...
            for(int j = 0; j < this.n; j++) {
                ...
                if(array[j].getData() > 0) {
                    ...
                    if(array[j].getName().charAt(0) == i + 65) MyIO.println(array[j].getName() + " " + array[j].getData());
                }
            }
        }
    }
...
class Hall {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while(true) {
            ...
            if(input.compareTo("FIM") == 0) break;
            ...
            else if(murder.getData() != -1) murder.setData(murder.getData() + 1);
