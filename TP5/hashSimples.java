...
class HashIndiretoLista {
    ...
    public void inserir(classGames elemento) {
...
class Celula {
    ...
    Celula(classGames elemento) {
        this.elemento = elemento;
        this.prox = null;
    }

    Celula(classGames elemento, Celula prox) {
        this.elemento = elemento;
        this.prox = prox;
    }
}
...
class hashSimples {
    ...
    public static void main(String[] args) throws Exception {
        ...
        HashIndiretoLista test = new HashIndiretoLista(21);
