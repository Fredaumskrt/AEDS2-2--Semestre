...
class Lista {
    ...
    public Lista(int tamanho) {
        array = new jogos[tamanho];
        n = 0;
    }

    public void inserirFim(jogos x) throws Exception {
    ...
    public void inserir(jogos x, int pos) throws Exception {
    ...
    public jogos removerInicio() throws Exception {
...
class jogos {
    ...
    public jogos(int app_id, String name, SimpleDateFormat dateOfYear, String owners, int age, float price,
            int dlcs,
...
class binaria {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            MyIO.println(test.pesqBin(nextEntry) ? "SIM" : "NAO");
        }
