...
class Lista {
    ...
    public classGames remover(int pos) throws Exception {
       ...
       classGames resp = array[pos].clone();
       n--;
...
class listaSequencial {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Usar debug no mostrar LISTA
        // INICIO DO FOR DO NEXTeNTRY
        ...
        for (int i = 0; i < nextEntry; i++) {
            ...
            begin[count] = MyIO.readLine();
            String action = begin[count].substring(0, 2); // recebe
            String reservation = ""; // reserva
            int posIR = 0;

            if (action.compareTo("I*") == 0) {
                posIR = Integer.parseInt(begin[count].substring(3, 5));
            ...
            if (action.compareTo("II") == 0) {
                ...
                MyIO.println("(R Inicio)" + " " + test.removerInicio().getname());
            } else if (action.compareTo("RF") == 0) {

                MyIO.println("(R fim)" + " " + test.removerFim().getname());
            }
        }
        test.mostrar();
