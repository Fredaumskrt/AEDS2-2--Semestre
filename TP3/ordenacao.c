...
void list_insertBegin(Game x) { // nao tira
...
void list_insertEnd(Game x) { // nao tira
...
void list_insert(Game x, int pos) { //nao tira
...
void selectionSort(Game arr[], int i, int n) {
    int min = i;
