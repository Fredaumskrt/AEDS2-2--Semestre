...
class Lista {
    ...
    public void sort() {
        ...
        classGames[] tmp = new classGames[n+1];
        for(int i = 0; i < n; i++){
           tmp[i+1] = array[i];
        }
        array = tmp;
    ...
    public void construir(int tamHeap) {
        for (int i = tamHeap; i > 1 && array[i].getdateOfYear().compareTo(array[i / 2].getdateOfYear()) > array[i / 2].getdateOfYear().compareTo(array[i].getdateOfYear()); i /= 2) {
            swap(i, i / 2);
        }
    }
    ...
    public void reconstruir(int tamHeap) {
        ...
        while (i <= (tamHeap / 2)) {
            ...
            if (array[i].getdateOfYear().compareTo(array[filho].getdateOfYear()) < array[filho].getdateOfYear().compareTo(array[i].getdateOfYear())) {
                swap(i, filho);
                i = filho;
                // count++;
            } else {
    ...
    //     int filho;
    //     if (2*i == tamHeap || array[2*i].getdateOfYear().compareTo(array[i].getdateOfYear()) > array[2*i+1].getdateOfYear().compareTo(array[2*1].getdateOfYear())){
    //        filho = 2*i;
    //     } else {
    //        filho = 2*i + 1;
    //     }
    ...
    public int getMaiorFilho(int i, int tamHeap) {
        int filho;
        if (2 * i == tamHeap || array[2 * i].getdateOfYear().compareTo(array[2 * i + 1].getdateOfYear()) >
         array[2 * i + 1].getdateOfYear().compareTo(array[2 * i].getdateOfYear())) {
            filho = 2 * i;
            count++;
        } else {
            filho = 2 * i + 1;
...
class classGames {
    ...
    public ArrayList<String> getdateOfYears() {
        return genres;
    }
